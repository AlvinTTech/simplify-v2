...
const stories = [
  {
    ...
    before: "Leads came in through WhatsApp, calls and website forms, but follow-up depended on manual tracking.",
    after: "AI qualifies leads, updates the CRM, sends follow-ups and books meetings automatically.",
  },
  {
    label: "Operations",
    title: "Less coordination. More execution.",
    before: "Managers spent hours checking updates, reminding teams and chasing task completion.",
    after: "Automated workflows send reminders, update task boards and notify the right people at the right time.",
  },
  {
    label: "Reporting",
    title: "Decisions without waiting for reports.",
    before: "Reports were prepared manually across spreadsheets, emails and different business tools.",
    after: "AI pulls data from connected systems and creates clear summaries for faster decision-making.",
  },
];
        ...
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              The goal is not to add AI for the sake of it. The goal is to
              remove delays, reduce manual work and help your business operate
              with more clarity.
            </p>
          </div>
