  ...
  return (
    <Section className="bg-slate-50">
      <SectionHeader
        ...
        title="Your team is not slow. Your systems are."
        description="Most businesses do not need more software. They need their existing tools, people and processes to work together without constant manual effort."
      />
